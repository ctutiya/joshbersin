...
function getelementcenter(task_element_path){
	var response = [];
	var new_task_point = jQuery_WPF(task_element_path);
    var new_task_point_offset = new_task_point.offset();

    var task_element_width = jQuery_WPF(task_element_path).width();
    var task_element_height = jQuery_WPF(task_element_path).height();
