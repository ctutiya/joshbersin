...
<div class="container">
	<form method="post" class="woocommerce-ResetPassword lost_reset_password align-center width-350 margin-auto">
		...
		<p class="woocommerce-form-row form-row">
			...
			<button type="submit" class="btn primary medium m-t-20" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>"><?php esc_html_e( 'Save', 'woocommerce' ); ?></button>
		</p>
