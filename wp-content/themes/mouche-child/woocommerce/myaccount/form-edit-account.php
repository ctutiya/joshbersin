    ...
    <div class="row justify-content-between width-800 gutter-15 align-items-center">
      <div class="col-auto">
        <div class="row gutter-15 align-items-center">
          <div class="col-auto">
            <img class="square-80 image-circle" src="<?php echo get_current_user_profile_picture(); ?>" alt="Profile picture">
          </div>
          <div class="col">
            <div class="p-l-5">
              <p class="caps color-primary m-b-10 type-bold font-12">NAME</p>
              <p><?php echo esc_attr( $user->first_name ) . ' ' . esc_attr( $user->last_name ); ?></p>
            </div>
          </div>
        </div>
      </div>
      <div class="col-auto">
        ...
        <p><?php echo $user_meta['afreg_additional_120'][0]; ?></p>
      </div>
...
<section class="block-bottom-padding-large">
  <div class="container-fluid p-l-25 p-r-25">
    ...
    <div class="row justify-content-between width-800 gutter-15 align-items-center">
      ...
      <div class="col">
        <?php echo $user_meta['afreg_additional_126'][0]; ?>
      </div>
      <div class="col align-right row align-items-center justify-content-end">
        <p class="font-12 caps p-r-30 type-bold">REMOVE</p>
...
<div class="account-edit-overlay row justify-content-center align-items-center ">
  <form action="<?php echo home_url('/wp-admin/admin-post.php'); ?>" method="post" class="change-account-details" enctype="multipart/form-data">
    ...
    <div class="account-edit-popup relative p-t-30 p-b-30 p-l-35 p-r-35 bg-white width-350 margin-auto m-t-60 m-b-60">
      <div data-edit="profile" >
        <p class="font-20 type-bold m-b-30">Edit profile</p>
        <div class="row justify-content-between align-items-center gutter-35 m-b-30">
          <div class="col-auto">
            <img id="profile-picture" class="image-circle square-90" src="<?php echo get_current_user_profile_picture(); ?>" alt="Profile picture">
          </div>
          <div class="col-auto">
      ...
      <div data-edit="job-title" >
        <p class="font-20 type-bold m-b-30">Edit Job Title</p>
        <label class="block">
      ...
      <div data-edit="email" >
        <p class="font-20 type-bold m-b-30">Edit Email Address</p>
        <label class="block">
      ...
      <div data-edit="employees" >
        <p class="font-20 type-bold m-b-30">Edit Number of Employees</p>
        <label class="block">
      ...
      <div data-edit="company-headquarters" >
        <p class="font-20 type-bold m-b-30">Edit Company Headquarters</p>
        <label class="block">
      ...
      <div data-edit="job-type" >
        <p class="font-20 type-bold m-b-30">Edit Job Type</p>
        <label class="block">
      ...
      <div data-edit="interests">
        <p class="font-20 type-bold m-b-30">Edit Interests</p>
      ...
      <div data-edit="password">
        <p class="font-20 type-bold m-b-30">Change Password</p>
